极客杨的OCR工具箱：Tesseract 是目前应用最广泛的免费开源OCR工具（背后有Google的支持）。商业产品有ABBYY的finereader，还有Adobe;国产的有文通和汉王。除了常规电脑的应用，Tesseract也被移植到智能手机（IOS 和 Android）。高通也发布了API 可以直接识别文字。资料卡片流： http://hao.memect.com/?tag=ocr-tools
